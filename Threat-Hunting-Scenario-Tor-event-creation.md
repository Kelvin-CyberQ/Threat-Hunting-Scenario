...
## Created By:
- **Author Name**: Kelvin with the help from Josh Madakor.
- **Author Contact**: https://www.linkedin.com/in/kelvin-quijada-196637170/
- **Date**: August 1, 2025
...
|-------------|-------------------------------|------------------|-------------------|
| 1.0         | Initial draft                  | `August 4, 2025`  | `Kelvin Q.`   
